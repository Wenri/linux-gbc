...
/* SPI regs */
#define LS2K_SPI_REG_BASE		(LS2K_IO_REG_BASE + 0x00e70000)
...
/* RTC regs */
#define LS2K_RTC_REG_BASE		(LS2K_IO_REG_BASE + 0x00e03000)
...
#define LS2K_GPIO_PIN_4			4
#define LS2K_GPIO_PIN_5			5
