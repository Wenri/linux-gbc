...
static struct insn insn_table[] = {
	...
	{ insn_dmfgc0, M(cop0_op, dmfgc_op, 0, 0, 0x4, 0), RT | RD | SET},
	{ insn_dmtc0, M(cop0_op, dmtc_op, 0, 0, 0, 0), RT | RD | SET},
	{ insn_dmtgc0, M(cop0_op, dmtgc_op, 0, 0, 0xc, 0), RT | RD | SET},
	...
	{ insn_mfgc0,  M(cop0_op, mfgc_op, 0, 0, 0, 0),  RT | RD | SET},
	...
	{ insn_mtgc0,  M(cop0_op, mtgc_op, 0, 0, 0x8, 0),  RT | RD | SET},
	...
	{ insn_tlbinvf,  M(cop0_op, cop_op, 0, 0, 0, tlbinvf_op),  0 },
	{ insn_tlbp,  M(cop0_op, cop_op, 0, 0, 0, tlbp_op),  0 },
	{ insn_tlbr,  M(cop0_op, cop_op, 0, 0, 0, tlbr_op),  0 },
	{ insn_tlbwi,  M(cop0_op, cop_op, 0, 0, 0, tlbwi_op),  0 },
	{ insn_tlbwr,  M(cop0_op, cop_op, 0, 0, 0, tlbwr_op),  0 },
	{ insn_hypcall,  M(cop0_op, cop_op, 0, 0, 0, hypcall_op),  0 },
